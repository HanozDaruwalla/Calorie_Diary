...
public class Food_Recycler_View_Functions {
    ...
    public void Data_Passer(ArrayList<String> userdata, ArrayList<String> UsernameDateFoodtype_Passed, Activity Activity_Data) {

        Log.d(TAG, "data = " + UsernameDateFoodtype_Passed.get(0) + "+" + UsernameDateFoodtype_Passed.get(1) + "+" + UsernameDateFoodtype_Passed.get(2));
        Log.d(TAG, "Vars Set");
        Database DB = new Database();
        DB.Get_Food_Data(UsernameDateFoodtype_Passed, new Breakfast_RecyclerView.Food_Data_FoundListener() {
            @Override
